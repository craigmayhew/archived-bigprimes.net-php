...
class index extends \pages{
  function getContent(){
    ...
    Watch this space for an open source GPU client coming soon...','date'=>'13th July 2011'),
      array('news'=>'We have added a page that shows the sum of the digits of prime numbers. <a class="link" href="/sumofdigits">Click here</a>','date'=>'10th February 2010'),
    ...
    $return = 
    '<h1>Prime Numbers</h1>'.
    'We currently have '.numbers::illion($primes->maxPrime,1).' Prime numbers available for you.'.
