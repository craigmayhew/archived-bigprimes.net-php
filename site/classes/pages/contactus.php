  ...
  function getContent(){
    ...
    if ($contact == 'sent'){
      if($_POST['email'] == ''){
        ...
        $message = 
        'This email was generated via the BIGprimes contact page. It is from '.$_POST['name'].
        '.<br /><br />'."\r\n\r\n".$_POST['message'];
              ...
              '<table width="450" bgcolor="#E0FAED" border="0" cellspacing="0" cellpadding="4">'.
                '<tr>'.
                  '<td valign="top" colspan="2" height="30">'.
                    '<font class="a">Please use this form for any feedback about the site. If you have any questions or problems with the site please don\'t hesitate to ask. We welcome any suggestions you may have.<br /><br />'.
                    '</font>'.
                  '</td>'.
                '</tr>'.
                '<tr>'.
                  '<td width="100" valign="top" height="30">'.
                    '<font class="a">Contact Name:</font>'.
                  '</td>'.
                  '<td>'.
                    '<input name="name" type="text" value="'.stripslashes($_POST['name']).'" />'.
                  '</td>'.
                '</tr>'.
                '<tr>'.
