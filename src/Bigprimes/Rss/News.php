...
class News extends \Bigprimes\Rss{
    public static $news = [
        ['description'=>'Site source code has been converted to PHP7 with Silex framework. Some methods have also been moved to cpp from PHP <a class="link" href="https://github.com/craigmayhew/bigprimes.net/">https://github.com/craigmayhew/bigprimes.net/</a>','date'=>'13th November 2016'],
        ['description'=>'You can now find the websites php source code here <a class="link" href="https://github.com/craigmayhew/bigprimes.net/">https://github.com/craigmayhew/bigprimes.net/</a>','date'=>'28th February 2014'],
        ['description'=>'I\'ve moved the database torrent to Amazons S3 to ensure the file always has peers available for download.','date'=>'26th January 2014'],
        ['description'=>'The complete database is now available for download as a torrent, please see the <a class="link" href="/faq/">FAQ</a> for details.','date'=>'3rd September 2012'],
...
Watch this space for an open source GPU client coming soon...','date'=>'13th July 2011'],
        ['description'=>'We have added a page that shows the sum of the digits of prime numbers. <a class="link" href="/sum-of-digits/">Click here</a>','date'=>'10th February 2010'],
        ['description'=>'Thanks to everyone for donating computer time, we are now upto 1.4 billion primes. We now also have a facebook group where you get news updates and show your support for the project!','date'=>'1st February 2010'],
        ...
        ['description'=>'We\'ve now added a <a class="link" href="/forum/">Forum</a> which can be found on the navigation links on the left.','date'=>'17th July 2008'],
        ['description'=>'Someone named Kirk just emailed me to say the download links wern\'t working. I\'ve now fixed this. Thanks Kirk!','date'=>'14th July 2008'],
        ['description'=>'Added much faster code to the cruncher so that we can handle more of your page loads! Lots of little updates and some reorganizing of the site.','date'=>'4th July 2008'],
        ['description'=>'Added the <a class="link" href="/downloads/">Downloads</a> section.','date'=>'23rd June 2007'],
        ['description'=>'Added the Fibonacci number archive containing the first 70331 Fibonacci numbers.','date'=>'11th February 2007'],
        ...
        ['description'=>'We have managed to archive the first 100 million prime numbers.','date'=>'28th September 2005'],
